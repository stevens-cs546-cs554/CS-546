...
async function main() {
	...
	const addCastNoDup = await advMongo.addCastMemberIfNotExists(1, 'Leonardo DiCaprio');
	console.log(addCastNoDup);

	const addCastDup = await advMongo.addCastMemberAllowDuplicates(1, 'Leonardo DiCaprio');
