...
async function runSetup() {
	...
	flatliners.cast.push('Kiefer Sutherland', 'Julia Roberts', 'Kevin Bacon', 'William Baldwin', 'Oliver Platt');

	const flatliners2017 = makeDoc('Flatliners', 5.2, 2017, 'Niels Arden Oplev');
	flatliners.cast.push('Ellen Page', 'Diego Luna', 'Nina Dobrev', 'James Norton', 'Kiersey Clemons');

	listOfMovies.push(inception, theLastSamurai, darkKnightRises, kingsman, flatliners, flatliners2017);
